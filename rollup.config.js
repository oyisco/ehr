...
const globals = {
    ...
    '@angular/animations': 'ng.animations',
    'ng-jhipster': 'ng-jhipster',
    '@angular/router': 'ng.router',
    'rxjs': 'rxjs',
    '@swimlane/ngx-datatable': '@swimlane/ngx-datatable',
    'rxjs/operators': 'rxjs.operators',
    '@alfresco/adf-core': 'adf-core',
    '@alfresco/js-api': 'js-api',
    'ngx-cookie': 'ngx-cookie',
    'ngx-store': 'ngx-store',
    '@lamis/web-core': 'lamis.web',
    'ngx-perfect-scrollbar': 'perfect-scrollbar',
